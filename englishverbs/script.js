const irregularVerbs = [
    ...
    function checkAnswer(input, answer) {
      ...
      function validate() {
          ...
          // Créez un élément span pour le chiffre correctCount
          const correctCountSpan = document.createElement("span");
          correctCountSpan.style.color = "red";
          
          // Vérifiez si correctCount a une décimale égale à zéro
          if (correctCount % 1 === 0) {
            correctCountSpan.textContent = correctCount.toFixed(0); // Pas de décimales
          } else {
            correctCountSpan.textContent = correctCount.toFixed(1); // Une décimale si nécessaire
          }
          
          // Créez un élément span pour la partie "/20."
          const outOfSpan = document.createElement("span");
          outOfSpan.textContent = "/20.";
          outOfSpan.style.color = "red";
          
          // Ajoutez les éléments span à la fin du texte
    ...
    var string = "Les Verbes Irréguliers";
